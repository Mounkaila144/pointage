 ...
 */
final class Version20220702173415 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `employee` (id INT AUTO_INCREMENT NOT NULL, groupe_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, naissance DATE DEFAULT NULL, image_name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_5D9F75A1E7927C74 (email), INDEX IDX_5D9F75A17A45358C (groupe_id), FULLTEXT INDEX `employee` (nom, prenom, email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pointage (id INT AUTO_INCREMENT NOT NULL, emploiyee_id INT NOT NULL, type VARCHAR(10) NOT NULL, date DATETIME NOT NULL, INDEX IDX_7591B20E398F566 (emploiyee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pointage ADD CONSTRAINT FK_7591B20E398F566 FOREIGN KEY (emploiyee_id) REFERENCES `employee` (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pointage DROP FOREIGN KEY FK_7591B20E398F566');
